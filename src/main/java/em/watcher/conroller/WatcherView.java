...
public class WatcherView implements Sessionable {
    ...
    @RequestMapping(value = {WatcherView.loginPage}, method = {RequestMethod.GET})
    ...
    @RequestMapping(value = {WatcherView.registerPage}, method = {RequestMethod.GET})
    public String registerPage(Model model) {
        model.addAttribute("user", new User());
        return WatcherView.registerPage;
    }

    @RequestMapping(value = {WatcherView.profilePage}, method = {RequestMethod.GET})
    public String profielPage(@ModelAttribute(Sessionable.User) User user) {
        return WatcherView.profilePage;
    }

    @RequestMapping(value = {WatcherView.indexPage}, method = {RequestMethod.GET})
